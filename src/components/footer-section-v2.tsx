    ...
    >
      <div className='relative overflow-hidden bg-[radial-gradient(circle_at_center,color-mix(in_oklab,var(--brand)_40%,transparent)_2px,transparent_2px)] bg-[length:24px_24px] bg-repeat pt-20'>
        ...
        <div className='text-brand absolute -bottom-1/6 left-1/2 mx-auto w-[90%] max-w-[1440px] -translate-x-1/2 opacity-10'>
          ...
          >
            <path
              d='M299.85 36L341.46 150.427H320.283L312.853 130.118H263.813L256.506 150.427H235.33L276.816 36H299.85ZM288.333 62.9969L271.119 110.18H305.546L288.333 62.9969Z'
              fill='currentColor'
            />
            <path
              d='M400.244 66.405C406.188 66.405 411.637 67.891 416.466 70.7393C421.296 73.5876 425.383 77.5505 428.231 82.504C431.079 87.4576 432.566 92.7827 432.566 98.8508V150.492H412.751V104.052C412.751 100.832 412.008 97.8601 410.398 95.2594C408.788 92.6588 406.683 90.5536 404.083 88.9437C401.482 87.3337 398.51 86.5907 395.29 86.5907C392.07 86.5907 389.098 87.3337 386.497 88.9437C383.897 90.5536 381.792 92.535 380.182 95.2594C378.572 97.9839 377.829 100.832 377.829 104.052V150.492H357.891L357.767 68.6341H377.705L377.829 75.9406C380.553 72.9684 383.897 70.6155 387.86 69.0056C391.822 67.3957 395.785 66.405 400.244 66.405Z'
              fill='currentColor'
            />
            <path
              d='M476.969 43.0291V68.6638H492.821V88.6019H476.969V150.398H457.031V88.6019H444.895V68.6638H457.031V43.0291H476.969Z'
              fill='currentColor'
            />
            <path
              d='M525.198 36L554.3 76L583.403 36H608.047L566.684 92.8421L608.542 150.427H583.774L554.3 109.932L524.827 150.427H500.059L541.917 92.8421L500.554 36H525.198Z'
              fill='currentColor'
            />
            <path
              d='M102.626 0L123.37 33.0031L41.716 163.898H0.32959L102.626 0ZM191.093 141.355L205.33 164H83.2041L97.4402 141.355H191.093ZM144.318 66.4124L170.349 108.149H118.388L144.318 66.4124Z'
              fill='currentColor'
            />
          </svg>
