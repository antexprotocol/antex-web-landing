...
function FooterSection() {
  ...
  return (
    <footer
      ...
      className={twMerge(
        "relative z-20 ",
        "px-4 md:px-0 snap-start text-t3 text-sm "
      )}
    >
      <div className="pt-20 relative overflow-hidden bg-[radial-gradient(circle_at_center,color-mix(in_oklab,var(--brand)_40%,transparent)_2px,transparent_2px)] bg-[length:24px_24px] bg-repeat">
        <div className="absolute top-0 left-0 size-full bg-gradient-to-b from-transparent to-[#000]" />
        <div className="pb-36 relative z-[1] max-w-[1200px] mx-auto py-20 flex flex-col md:flex-row md:gap-0">
          {/* Logo and Description */}
          <div
            className={twMerge(
              "md:w-1/4 flex flex-col gap-2 md:gap-8 transition-all duration-700",
          ...
          >
            <div className="flex items-center gap-3">
              <img
                ...
                className="md:w-[229px] w-[120px]"
                alt="logo"
              />
            </div>
            <div className="text-xl md:text-base leading-relaxed">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              {socials.map((s) => (
                <a
                  ...
                  className="text-[#454545] hover:text-brand"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div
            className={twMerge(
              "justify-end pc ml-auto sm:min-w-[616px] grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(184px,1fr))] gap-8 transition-all duration-700 delay-200",
              inViewport ? "translate-y-0" : "translate-y-20"
            )}
          >
            <div>
          ...
          <div
            className={twMerge(
              "mt-6 sp grid-rows-[repeat(3, 1fr)] md:grid-rows-none md:ml-auto sm:min-w-[616px] grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(184px,1fr))] gap-8 transition-all duration-700 delay-200",
              inViewport ? "translate-y-0" : "translate-y-20"
            )}
          >
            <Accordion
