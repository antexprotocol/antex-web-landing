...
function MarketSection() {
  ...
  return (
    <div className=" bg-black relative py-[88px] flex flex-col items-center justify-center overflow-hidden">
      ...
      <h3 className="text-[44px] font-bold">{t("web.home.market.title")}</h3>
      <h4 className="mt-6 text-t3 text-xl font-light text-center max-w-[880px]">{t("web.home.market.sub_title")}</h4>
